...
//		행의 개수만 지정한 채 배열을 선언하면 한 번 접근해서 찾아갔을 때 연결되어 있는 공간들(소배열들)이
//		존재하지 않기 때문에 주소값의 초기값인 null 값을 담고 있다. 2차원 배열을 제대로 사용하려면
//		소배열들을 만들어서 연결해주는 작업부터 하고 사용해야 한다.
		...
		System.out.println("행의개수 : "+arrData3.length);	//2차원배열명.length : 행의 개수
		System.out.println("0행의 열수 : "+arrData3[0].length);	//2차원배열명[행번호].length : 각 행의 열의 개수
